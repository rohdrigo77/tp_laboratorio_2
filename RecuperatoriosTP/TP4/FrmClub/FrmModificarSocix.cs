...
namespace FrmClub
{
    ...
    public partial class FrmModificarSocix : Form
    {
        ...
        public event ModificarBotones actualizarBotones;
        public event AccionesFormulario actualizarAccionesFormulario;
        Socix socix;
        ...
        private void FrmModificarSocix_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                tarea.Start();
                this.actualizarBotones += () => frmListDatos.AbrirFormularioParaModificarDatos();
                this.ActualizarBotones();
                this.actualizarAccionesFormulario += () => frmListDatos.CerrarFormulario();

            }
            catch (Exception ex)
            {
                MessageBox.Show($"{ex.Message}.", "Error en la carga del formulario", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void ActualizarBotones()
        {
            ...
            if (this.actualizarBotones != null)
            {
                this.actualizarBotones.Invoke();
            }
        ...
        private void ActualizarAcciones()
        {
            ...
            if (this.actualizarAccionesFormulario != null)
            {
                this.actualizarAccionesFormulario.Invoke();
            }

        }

        private void FrmModificarSocix_FormClosing(object sender, FormClosingEventArgs e)
        {
