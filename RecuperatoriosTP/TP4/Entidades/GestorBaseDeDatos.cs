        ...
        public void ObtenerSocix(SqlCommand sqlCommand, List<Socix> list)
        {
            ...
            using (this.sqlConexion)
            {
                ...
                if (data != null)
                {
                    while (data.Read())
                    {
                        if (data.GetString(12) != "No Corresponde")
                        {
                            socix = new Nadador();
                        ...
                        double cuota = data.GetDouble(6);

                        if (cuota == Club.ValorCuotaNinixsNatacion)
                        {
                        ...
                        {
                            if (cuota == Club.ValorCuotaAdultxsNatacion)
                            {
                            ...
                            {
                                if (cuota == Club.ValorCuotaNinixsFutbol)
                                {
                                ...
                                {
                                    if (cuota == Club.ValorCuotaAdultxsFutbol)
                                    {
                                    ...
                                    {
                                        if (cuota == Club.ValorCuotaNinixsBoxeo)
                                        {
                                        ...
                                        {
                                            if (cuota == Club.ValorCuotaAdultxsBoxeo)
                                            {
