...
namespace Entidades
{
    public class Club
    {
        ...
        static double valorCuotaNinixsNatacion;
        static double valorCuotaAdultxsNatacion;
        static double valorCuotaNinixsFutbol;
        static double valorCuotaAdultxsFutbol;
        static double valorCuotaNinixsBoxeo;
        static double valorCuotaAdultxsBoxeo;
        ...
        public static double ValorCuotaNinixsNatacion       
        {
            set
            {                
                if (value > 0)
        ...
        public static double ValorCuotaAdultxsNatacion
        {
            set
            {
                if (value > 0)
        ...
        public static double ValorCuotaNinixsFutbol
        {
            set
            {
                if (value > 0)
        ...
        public static double ValorCuotaAdultxsFutbol
        {
            set
            {
                if (value > 0)
        ...
        public static double ValorCuotaNinixsBoxeo
        {
            set
            {
                if (value > 0)
        ...
        public static double ValorCuotaAdultxsBoxeo
        {
            set
            {
                if (value > 0)
